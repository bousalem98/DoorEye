...
public class ForegroundCallService extends Service {
    ...
    public void onCreate() {
        ...
        DatabaseReference ringingRef = database.getReference("BoxList").child("hopA12")
                .child("history");
      /*  ringingRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                Intent notificationIntent = new Intent(ForegroundCallService.this, MainActivity.class);
                onStartCommand(notificationIntent,12,1);
            }
